...
\begin{itemize}
\item \textbf{METANET:} the technical aspect of a project of the \textbf{Meta-D.O.N Association}: investigation of sociocultural transformations in Serbia from scientific and artistic perspective - \textbf{New[B]Order} - \htmladdnormallink{http://www.meta-don.org/newborder/}{http://www.meta-don.org/newborder/}
\item project on the topography of the centre-periphery-complex in post-socialist Eastern Europe using the example of Belgrade
...
\begin{itemize}
	\item e.g. indicators
	\begin{itemize}
		\item privatization aspects of companies in Serbia - \textbf{Freedom Fighters Activists} (\htmladdnormallink{http://www.freedomfight.net/cms/}{http://www.freedomfight.net/cms/})
...
\frame
{
\frametitle{\textbf{project partners}}
\begin{itemize}
	%\includegraphics[width=0.35\textwidth]{bin/logos/logo_ck13.png}
	\item \textbf{\htmladdnormallink{CK13, Novi Sad (SRB)}{http://ck13.org/en}}
	
	%\includegraphics[width=0.35\textwidth]{bin/logos/logo_ff.png}
	\item \textbf{\htmladdnormallink{Freedom Fight Activists (SRB)}{http://www.freedomfight.net/cms/}}
	
	%\includegraphics[width=0.35\textwidth]{bin/logos/logo_kuda.png}
	\item \textbf{\htmladdnormallink{Kuda.org - New Media Center, Novi Sad (SRB)}{http://http://www.kuda.org/en}}
	
	%\includegraphics[width=0.35\textwidth]{bin/logos/logo_mcab.png}
	\item \textbf{\htmladdnormallink{Museum Of Contemporary Art, Belgrade (SRB)}{http://msub.org.rs/en}}
	
	%\includegraphics[width=0.35\textwidth]{bin/logos/logo_instgs.png}
	\item \textbf{\htmladdnormallink{Institute for Social- and Welfare Policy, JKU Linz (AT)}{http://www.gespol.jku.at/}}

	%\includegraphics[width=0.35\textwidth]{bin/logos/logo_icae.png}
	\item \textbf{\htmladdnormallink{Institute for Comprehensive Analysis of Economy, JKU Linz (AT)}{http://www.icae.at/wp//}}
	
	%\includegraphics[width=0.35\textwidth]{bin/logos/logo_fro.png}
	\item \textbf{\htmladdnormallink{Editorial Collaboration: Radio FRO – Freies Radio Oberösterreich (AT)}{http://www.fro.at/}}
\end{itemize}
}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{enlarges the collective knowledge} of individuals (tacit knowledge)
		...
		\item COP will enable members to leverage the knowledge that exists in a knowledge network more quickly
	\end{itemize}
...
\begin{itemize}
	...
	\item Gerhard Dirmoser creates complex large-scale wall diagrams on topics like \textbf{25 years of ARS Electronica} (2003)
\end{itemize}
}
...
\frametitle{\textbf{semaspace outline}}
\begin{itemize}
	\item possible to manually \textbf{define the nodes' overall shape} of the network by placing and subsequently locking the position of individual nodes
...
\begin{itemize}
\item \textbf{generating rendered graphics} by using tools:
	\begin{itemize}
...
\textbf{\htmladdnormallink{http://www.meta-don.org/newborder}{http://www.meta-don.org/newborder}}\\
\textbf{office@meta-don.org}
\end{center}
}
